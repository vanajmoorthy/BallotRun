...
public class GameStateTitle extends GameState {
    ...
    private GestureDetector buttonStartGame = new GestureDetector(
        (sketch, hitbox, hasHover, hasClick) -> {
            ...
            sketch.noStroke();
            sketch.rect(
                Constants.Screen.width / 2 - 100,
                Constants.Screen.height / 2 + 50 - 20,
                200,
                40,
                10
            );
            ...
            sketch.text(
                ...
                Constants.Screen.height / 2 + 50 - 20 + 17.5f
            );
        },
        (sketch, button) -> {
            didSwitchState = true;
