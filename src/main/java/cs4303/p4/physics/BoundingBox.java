...
public class BoundingBox {
    ...
    // float distToLeft = dist(c.getLocation().x, c.getLocation().y,
    // this.getLocation().x, constrain(c.getLocation().y, this.getLocation().y,
    // this.getLocation().y + this.height));
    // float distToRight = dist(c.getLocation().x, c.getLocation().y,
    // this.getLocation().x + this.width, constrain(c.getLocation().y,
    // this.getLocation().y, this.getLocation().y + this.height));
    // float distToTop = dist(c.getLocation().x, c.getLocation().y,
    // constrain(c.getLocation().x, this.getLocation().x, this.getLocation().x +
    // this.width), this.getLocation().y);
    // float distToBottom = dist(c.getLocation().x, c.getLocation().y,
    // constrain(c.getLocation().x, this.getLocation().x, this.getLocation().x +
    // this.width), this.getLocation().y + this.height);
